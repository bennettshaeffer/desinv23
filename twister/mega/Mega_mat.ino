...
void loop() {
  ...
  button21Reading = digitalRead(button20);
  ...
  if (button1Reading == 0 && button2Reading == 0 && button3Reading == 0 && button4Reading == 0 && button5Reading == 0 && button7Reading == 0 && button12Reading == 0 && button15Reading == 0 && button16Reading == 0 && button17Reading == 0 && button18Reading == 0 && button19Reading == 0 && button20Reading == 0 && button22Reading == 0 && button23Reading == 0 && button27Reading == 0 && button28Reading)
  {
    if (hold == 0)
    {
      tBegin = time;
